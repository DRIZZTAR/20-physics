...
var CameraNode = class _CameraNode extends Object3DNode_default {
  ...
  getNodeType(builder) {
    const scope = this.scope;
    if (scope === _CameraNode.PROJECTION_MATRIX || scope === _CameraNode.PROJECTION_MATRIX_INVERSE) {
      return "mat4";
  ...
  update(frame) {
    ...
    } else if (scope === _CameraNode.PROJECTION_MATRIX_INVERSE) {
...
var textureStoreBase = nodeProxy(TextureStoreNode);
...
var getIBLVolumeRefraction = tslFn(([n, v, roughness2, diffuseColor2, specularColor2, specularF902, position, modelMatrix, viewMatrix, projMatrix, ior2, thickness2, attenuationColor2, attenuationDistance2]) => {
  ...
  const transmittedLight = getTransmissionSample(refractionCoords, roughness2, ior2);
  const transmittance = diffuseColor2.mul(volumeAttenuation(length(transmissionRay), attenuationColor2, attenuationDistance2));
...
var PhysicalLightingModel = class extends LightingModel_default {
  constructor(clearcoat2 = false, sheen2 = false, iridescence2 = false, anisotropy2 = false, transmission2 = false) {
    super();
...
var MeshPhysicalNodeMaterial = class extends MeshStandardNodeMaterial_default {
  ...
  setupLightingModel() {
    return new PhysicalLightingModel_default(this.useClearcoat, this.useSheen, this.useIridescence, this.useAnisotropy, this.useTransmission);
  }
...
var defaultValues13 = new ShadowMaterial();
